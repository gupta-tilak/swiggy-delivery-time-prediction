...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='gupta-tilak', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/gupta-tilak/swiggy-delivery-time-prediction.mlflow")
